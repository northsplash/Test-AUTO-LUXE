...
export const FAQS: { q: string; a: string; group: 'Service' | 'Pricing' | 'Booking' | 'Care' }[] = [
  ...
  { group: 'Service', q: 'Do you offer mobile detailing?', a: 'Yes. We come to you all over North Carolina when mobile service is available. A mobile service fee may apply depending on location and service requirements.' },
  ...
  { group: 'Booking', q: 'How do I schedule?', a: `Pick a preferred date and time on the Book tab. We confirm that window by email or at ${MARKET.phone} before a detailer is dispatched.` },
